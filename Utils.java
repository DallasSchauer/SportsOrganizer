...
class Utils {
    ...
    public static void quickSortDates (Game arr[], int low, int high) {
        ...
        for (int j = low; j < high; j++) {
        	...
        	// Organized it this way just to get rid of warning in eclipse, will still function the same way 
        	retLong = compareDates(arr[j].time, pivot);
            if (retLong == arr[j].time) {
